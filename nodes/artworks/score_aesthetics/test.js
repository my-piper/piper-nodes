...
Deno.test(
  "ArtWorks Score Aesthetics: costs calculation for regular scope",
  () => {
    const result = costs({
      env: { scope: {} },
      inputs: {},
...
Deno.test("ArtWorks Score Aesthetics: costs are zero for user scope", () => {
  const result = costs({
...
Deno.test(
  "ArtWorks Score Aesthetics: score aesthetics of an image",
  async () => {
    const {
      costs,
      outputs: { scores },
    ...
    console.log("Aesthetics scores:", scores);
